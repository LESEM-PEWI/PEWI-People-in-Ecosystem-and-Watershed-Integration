...
function refreshEconTotals(yearToLoad){
  ...
  let carbonCredit= Math.round(economics.GHGsScore[yearToLoad][0]?.C02_e* 10) / 10 * economics.GHGsScore[yearToLoad][0]?.SOC;
  let totalRevenue = carbonCredit + economics.totalWatershedRevenue[yearToLoad][0].revenue;
